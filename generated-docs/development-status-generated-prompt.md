...
## 現在のオープンIssues
## [Issue #74](../issue-notes/74.md): 動作が安定し、音はC言語版より改善（末尾がより適切）となった。よってドキュメントを整備して、リポジトリをクリーンにし、ハルシネーション確率を下げる
...
ac51ed9 test data
e327eaa github-actionsリポジトリの共通ワークフローを導入
a3832fd jekyll settings
